...
export const removeTaskTC = (arg: { taskId: string; todolistId: string }) => async (dispatch: Dispatch) => {
  try {
    dispatch(setAppStatusAC("loading"))
...
export const addTaskTC = (arg: { title: string; todolistId: string }) => async (dispatch: Dispatch) => {
  try {
    dispatch(setAppStatusAC("loading"))
